...
namespace nap 
{
    ...
    private:
		...
		ObjectPtr<RenderTexture2D>  mHapTexture1;					///< Pointer to the Hap video texture
		ObjectPtr<RenderTexture2D>  mHapTexture2;					///< Pointer to the Hap video texture
		ObjectPtr<RenderTexture2D>  mHapTexture3;					///< Pointer to the Hap video texture
		ObjectPtr<RenderTexture2D>  mHapTexture4;					///< Pointer to the Hap video texture
		ObjectPtr<RenderTexture2D>  mHapTexture5;					///< Pointer to the Hap video texture

		ObjectPtr<EntityInstance>   mRenderVideoEntity;				///< Pointer to the entity that renders the video

        ObjectPtr<ThreadedVideoPlayer> mVideoPlayer1;
        ObjectPtr<ThreadedVideoPlayer> mVideoPlayer2;
        ObjectPtr<ThreadedVideoPlayer> mVideoPlayer3;
        ObjectPtr<ThreadedVideoPlayer> mVideoPlayer4;
        ObjectPtr<ThreadedVideoPlayer> mVideoPlayer5;
