...
namespace nap
{
    class VideoPlayerAdvancedBase;

	class NAPAPI VideoAdvancedService : public Service
	{
		RTTI_ENABLE(Service)
	public:
		// Default Constructor
		VideoAdvancedService(ServiceConfiguration* configuration) : Service(configuration)	{ }
		...
		*/
        ...
        void registerPlayer(VideoPlayerAdvancedBase& player);

        void removePlayer(VideoPlayerAdvancedBase& player);

        void registerObjectCreators(rtti::Factory &factory) override;
    private:
        std::vector<VideoPlayerAdvancedBase*> mPlayers;	///< All players
	};
}
